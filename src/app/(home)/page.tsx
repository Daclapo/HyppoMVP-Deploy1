...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <section id="crear-publicacion" className="mt-16 mb-16">
        <h2 className="text-2xl font-semibold mb-6">Crear nueva publicación</h2>
      ...
      <section id="sugerencias" className="max-w-4xl mx-auto mt-16 mb-20">
        <h2 className="text-2xl font-semibold mb-6">Sugerencias</h2>
        <SuggestionsList />
      </section>
    </div>
  );
